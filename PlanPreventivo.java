...
public class PlanPreventivo {
	...
	private int aceiteTransimisionKm;
	...
	public int getAceiteTransimisionKm() {
		return aceiteTransimisionKm;
	}
	public void setAceiteTransimisionKm(int aceiteTransimisionKm) {
		this.aceiteTransimisionKm = aceiteTransimisionKm;
	}
	public int getAceiteTransimisionMes() {
		return aceiteTransimisionMes;
	}
	public void setAceiteTransimisionMes(int aceiteTransimisionMes) {
		this.aceiteTransimisionMes = aceiteTransimisionMes;
	}
	...
	public PlanPreventivo(String condicionesUso, String comentarios, int liquidoFrenosKm, int liquidoFrenosMes,
			int operacionesSistematicasKm, int operacionesSistematicasMes, int filtroAireKm, int filtroAireMes,
			int filtroAireHabitaculoKm, int filtroAireHabitaculoMes, int filtroCombustibleKm, int filtroCombustibleMes,
			int filtroAntipolenKm, int filtroAntipolenMes, int correaDistribucionKm, int correaDistribucionMes,
			int kitDistribucionKm, int kitDistribucionMes, int reglajeProyectoresKm, int reglajeProyectoresMes,
			int pHLiquidoRefrigeracionKm, int pHLiquidoRefrigeracionMes, int liquidoRefrigeracionKm,
			int liquidoRefrigeracionMes, int correaArrastreAccesoriosKm, int correaArrastreAccesoriosMes,
			int kitCorreaArrastreAccesoriosKm, int kitCorreaArrastreAccesoriosMes, int anticongelanteKm,
			int anticongelanteMes, int aceiteTransimisionKm, int aceiteTransimisionMes, int bujiasEncendidoKm,
			int bujiasEncendidoMes) {
		super();
		this.condicionesUso = condicionesUso;
		this.comentarios = comentarios;
		this.liquidoFrenosKm = liquidoFrenosKm;
	...
	public String toString() {
		return "PlanPreventivo [condicionesUso=" + condicionesUso + ", comentarios=" + comentarios
				+ ", liquidoFrenosKm=" + liquidoFrenosKm + ", liquidoFrenosMes=" + liquidoFrenosMes
				+ ", operacionesSistematicasKm=" + operacionesSistematicasKm + ", operacionesSistematicasMes="
				+ operacionesSistematicasMes + ", filtroAireKm=" + filtroAireKm + ", filtroAireMes=" + filtroAireMes
				+ ", filtroAireHabitaculoKm=" + filtroAireHabitaculoKm + ", filtroAireHabitaculoMes="
				+ filtroAireHabitaculoMes + ", filtroCombustibleKm=" + filtroCombustibleKm + ", filtroCombustibleMes="
				+ filtroCombustibleMes + ", filtroAntipolenKm=" + filtroAntipolenKm + ", filtroAntipolenMes="
				+ filtroAntipolenMes + ", correaDistribucionKm=" + correaDistribucionKm + ", correaDistribucionMes="
				+ correaDistribucionMes + ", kitDistribucionKm=" + kitDistribucionKm + ", kitDistribucionMes="
				+ kitDistribucionMes + ", reglajeProyectoresKm=" + reglajeProyectoresKm + ", reglajeProyectoresMes="
				+ reglajeProyectoresMes + ", pHLiquidoRefrigeracionKm=" + pHLiquidoRefrigeracionKm
				+ ", pHLiquidoRefrigeracionMes=" + pHLiquidoRefrigeracionMes + ", liquidoRefrigeracionKm="
				+ liquidoRefrigeracionKm + ", liquidoRefrigeracionMes=" + liquidoRefrigeracionMes
				+ ", correaArrastreAccesoriosKm=" + correaArrastreAccesoriosKm + ", correaArrastreAccesoriosMes="
				+ correaArrastreAccesoriosMes + ", kitCorreaArrastreAccesoriosKm=" + kitCorreaArrastreAccesoriosKm
				+ ", kitCorreaArrastreAccesoriosMes=" + kitCorreaArrastreAccesoriosMes + ", anticongelanteKm="
				+ anticongelanteKm + ", anticongelanteMes=" + anticongelanteMes + ", aceiteTransimisionKm="
				+ aceiteTransimisionKm + ", aceiteTransimisionMes=" + aceiteTransimisionMes + ", bujiasEncendidoKm="
				+ bujiasEncendidoKm + ", bujiasEncendidoMes=" + bujiasEncendidoMes + "]";
	}
